...
const Information = () => {
    ...
    const loadInformation = () => {
        ...
        if (jewelleryPage === JewelleryPage.METAL_CONVERTER) {
        ...
        else if (jewelleryPage === JewelleryPage.RING_RESIZER) {
        ...
        else if (jewelleryPage === JewelleryPage.RING_WEIGHT) {
        ...
        else if (jewelleryPage === JewelleryPage.ROLLING_WIRE) {
